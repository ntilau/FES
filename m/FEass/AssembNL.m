...
% Assemble FE matrices for a single-frequency nonlinear problem,
% with Kerr-type permittivity update at each Newton iteration.
...
for ie = 1:Mesh.NELE
    ...
    %% Kerr permittivity update at element center
...
%% Boundary conditions (ABC, DD, Dir, Neu, WP) -- same pattern
if FlagABC
