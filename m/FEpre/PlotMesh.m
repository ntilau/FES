...
% Plot a finite-element mesh: nodes, edges, elements with labels or numbering.
% Type = 0: element, edge, and node numbering; Type = 1: labels.
if nargin < 2
    Type = 0;
end
switch Type
