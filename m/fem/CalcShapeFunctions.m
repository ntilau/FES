function [Shape, ShapeDerivX, ShapeDerivY] = CalcShapeFunctions(dim, p)
% Return function handles for hierarchical scalar basis functions
% and their derivatives on a 1-D or 2-D simplex (triangle).
%
%   dim : 1 (line segment) or 2 (triangle)
%   p   : polynomial order (1-4 for 1-D, 1-4 for 2-D)
