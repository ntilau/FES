%% ProjectWaveScatteringDD - Solve wave scattering with domain decomposition iteration
clear; close all;
Config()
...
%% Assemble full system A and B matrices
...
%% Recover total field from subdomains
